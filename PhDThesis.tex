...
\usepackage{appendix}
\linespread{1.5}
\usepackage[lmargin=40mm, rmargin=20mm]{geometry}
\usepackage{lineno}
\usepackage{bbold}
\usepackage{xspace}
\usepackage{epstopdf}
...
{\LARGE \bfseries Measurement of the inclusive top quark pair with radiated photon production cross-section in the dilepton channel for pp collisions at 8 TeV}\\[0.2cm] 
