...
\textbf{Loose electrons} are selected from electron candidates that failed electron selection and have:
...
\textbf{Loose Muons} are selected from PF muons failing the muon selection that have:
