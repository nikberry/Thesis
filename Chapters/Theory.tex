...
\begin{figure} \label{fig-ttbarCombinedXsect}
\begin{center}
...
\begin{table} \label{tab-ttbarcrosssections}
\begin{center}
...
\begin{figure} \label{fig-ttbarDecay}[h!]
\begin{center}
