...
There is great interest as to the determination of the coupling of the top quark and photon, and probing the $t\bar{t}\gamma$ channel provides direct access to test
this vertex. Any deviation from that of SM prediction would imply an anomalous structure of the vertex, thus revealing theorised physics beyond that of the SM. 

A set of eight operators, $O_x$, known as effective operators, can be found to parametrise quark couplings up to a scale $\Lambda$ \cite{anom-coups}. They appear linearly in an
...
The interaction Lagrangian for the top-photon vertex, shown in Fig. \ref{fig-TopPhotonVertex}, can be written in the form \cite{anom-coups}:
